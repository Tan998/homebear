      ...
      <div class="main-sidebar sidebar-style-2">
        <aside id="sidebar-wrapper">
          ...
          <ul class="sidebar-menu">
            ...
            <li class="<?php echo $this->uri->segment(2) == 'NewsList' || $this->uri->segment(2) == 'NewsCreate' ? 'active' : ''; ?>"><a class="nav-link" href="<?= site_url('news_manager/index') ?>"><i class="fa fa-file-image"></i> <span>News Manager</span></a></li>
