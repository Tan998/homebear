...
<?php
  ...
  <script src="<?php echo base_url(); ?>assets/modules/chart.min.js"></script>
<?php
}elseif ($this->uri->segment(2) == "modules_datatables" || $this->uri->segment(2) == "PostsListManage") { ?>
  <script src="<?php echo base_url(); ?>assets/modules/datatables/datatables.min.js"></script>
  <script src="<?php echo base_url(); ?>assets/modules/datatables/DataTables-1.10.16/js/dataTables.bootstrap4.min.js"></script>
  <script src="<?php echo base_url(); ?>assets/modules/datatables/Select-1.2.4/js/dataTables.select.min.js"></script>
  <script src="<?php echo base_url(); ?>assets/modules/jquery-ui/jquery-ui.min.js"></script>
<?php
}elseif ($this->uri->segment(2) == "modules_datatables" || $this->uri->segment(2) == "ContactManager") { ?>
  <script src="<?php echo base_url(); ?>assets/modules/datatables/datatables.min.js"></script>
  <script src="<?php echo base_url(); ?>assets/modules/datatables/DataTables-1.10.16/js/dataTables.bootstrap4.min.js"></script>
  <script src="<?php echo base_url(); ?>assets/modules/datatables/Select-1.2.4/js/dataTables.select.min.js"></script>
  <script src="<?php echo base_url(); ?>assets/modules/jquery-ui/jquery-ui.min.js"></script>
<?php
}elseif ($this->uri->segment(2) == "modules_datatables" || $this->uri->segment(2) == "Download_Materials_Manager") { ?>
  <script src="<?php echo base_url(); ?>assets/modules/datatables/datatables.min.js"></script>
  <script src="<?php echo base_url(); ?>assets/modules/datatables/DataTables-1.10.16/js/dataTables.bootstrap4.min.js"></script>
  <script src="<?php echo base_url(); ?>assets/modules/datatables/Select-1.2.4/js/dataTables.select.min.js"></script>
  <script src="<?php echo base_url(); ?>assets/modules/jquery-ui/jquery-ui.min.js"></script>
...
<?php
}elseif ($this->uri->segment(2) == "PostsListManage") { ?>
  <script src="<?php echo base_url(); ?>assets/js/page/post-datatables.js"></script>
<?php
}elseif ($this->uri->segment(2) == "ContactManager") { ?>
  <script src="<?php echo base_url(); ?>assets/js/page/contact-datatables.js"></script>
<?php
}elseif ($this->uri->segment(2) == "Download_Materials_Manager") { ?>
  <script src="<?php echo base_url(); ?>assets/js/page/download-materials-datatables.js"></script>
<?php
